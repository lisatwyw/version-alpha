...
with tab1:    
    ...
    st.write( "Click on a column to have rows sorted by that column.")    
    st.write( "To see more data, hover mouse over top-right corner for additional widgets to shown up.")    
